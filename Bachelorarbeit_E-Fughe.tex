...
Betrachtet man den Mittelwert im Zeitverlauf ergibt sich eine bimodale\footnote{Eine Wahrscheinlichkeitsverteilung heißt \textbf{bimodale}, wenn ihre Dichte zwei Modi aufweist.} Verteilung  der Häufigkeit der Ameisen, die die eine bzw. andere Nahrungsquelle aufsuchen \parencite{AL:2008}.\\
...
Befindet sich man nicht nah an den Rändern $x\pm 1$ dominiert Herding-Mechanismus und die Veränderungen werden vom quadratischen Term repräsentiert, sodass der von $N$ abhängige Term vernachlässigt werden kann. 
Befindet man sich allerdings an den Rändern, sind beide Effekte gleichgroß und -bedeutend \parencite{AL:2008}. 
...
Das Modell kann nun mittels Langevin-Gleichung simuliert werden. Die Langevin-Gleichung liefert eine Gaußsche Approximation an die stochastischen Dynamiken
